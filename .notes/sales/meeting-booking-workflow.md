...
1. **If** there is a person that needs outreach → **draft outreach sends** → go to top
...
Define “needs outreach” and queue order using your fields and Bases (`outreach_status`, `next_step_date`, `Outreach Sends`, etc.).
