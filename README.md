...
- **Agent skills (Cursor + Codex):** `.agents/skills/` — e.g. `extend-sales-obsidian-vault`, `edit-sales-obsidian-vault-notes`, `sales-outreach-playbook` (each folder has `SKILL.md`).
